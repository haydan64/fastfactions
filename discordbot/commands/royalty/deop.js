...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('deop')
    .setDescription('Demote a player to member and persist the change (Royalty only)')
  ...
  async execute(
    ...
    await interaction.reply({ content: `Operator status removed for XUID **${xuid}**.`, ephemeral: true });
  }
};
